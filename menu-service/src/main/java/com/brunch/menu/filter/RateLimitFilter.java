...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    static {
        RULES.put("POST:/api/admin/menu",   new int[]{30, 60});
        RULES.put("PUT:/api/admin/menu",    new int[]{30, 60});
        RULES.put("DELETE:/api/admin/menu", new int[]{30, 60});
        RULES.put("GET:/api/menu",          new int[]{60, 60});
